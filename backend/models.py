...
class WeeklyInvoice(Base):
    ...
    billing_charges = Column(Float, nullable=False, default=0)
    profit_percent = Column(Float, nullable=False, default=0)
    ...
    current_week_payable = Column(Float, nullable=False, default=0)
    payments_this_week = Column(Float, nullable=False, default=0)
    payments_after_week = Column(Float, nullable=False, default=0)
    total_payments_till_today = Column(Float, nullable=False, default=0)
    ledger_balance = Column(Float, nullable=False, default=0)
    final_outstanding = Column(Float, nullable=False, default=0)
    advance_remaining = Column(Float, nullable=False, default=0)
...
class WeeklyInvoiceItem(Base):
    ...
    amount = Column(Float, nullable=False, default=0)
    source_ledger_id = Column(Integer, nullable=True, index=True)
    entry_date = Column(Date, nullable=True, index=True)
    charge_type = Column(String, nullable=True, index=True)
    description = Column(Text, nullable=True)
    amount_usd = Column(Float, nullable=False, default=0)
    amount_inr = Column(Float, nullable=False, default=0)
    profit_eligible = Column(Boolean, nullable=False, default=False)
